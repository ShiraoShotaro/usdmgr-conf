...
set_target_properties(tf PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "Shlwapi.lib;arch;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/lib/tbb_debug.lib>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/lib/tbb.lib>"
...
set_target_properties(trace PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
  INTERFACE_LINK_LIBRARIES "tf;js;arch;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/lib/tbb_debug.lib>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/lib/tbb.lib>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
)
...
set_target_properties(plug PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
  INTERFACE_LINK_LIBRARIES "tf;arch;trace;work;js;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/lib/tbb_debug.lib>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/lib/tbb.lib>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
)
...
set_target_properties(vt PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
  INTERFACE_LINK_LIBRARIES "tf;trace;arch;gf;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/lib/tbb_debug.lib>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/lib/tbb.lib>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
)
...
set_target_properties(pcp PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
  INTERFACE_LINK_LIBRARIES "tf;sdf;trace;work;ar;vt;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/lib/tbb_debug.lib>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/lib/tbb.lib>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
)
...
set_target_properties(usd PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
  INTERFACE_LINK_LIBRARIES "pcp;tf;sdf;plug;arch;trace;work;kind;ar;vt;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/lib/tbb_debug.lib>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/lib/tbb.lib>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
)
...
set_target_properties(usdGeom PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
  INTERFACE_LINK_LIBRARIES "vt;usd;tf;sdf;plug;trace;work;js;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/lib/tbb_debug.lib>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/lib/tbb.lib>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
)
...
set_target_properties(usdSkel PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
  INTERFACE_LINK_LIBRARIES "usd;gf;tf;usdGeom;sdf;arch;trace;work;vt;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/lib/tbb_debug.lib>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/lib/tbb.lib>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
)
...
set_target_properties(usdPhysics PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
  INTERFACE_LINK_LIBRARIES "usd;tf;usdGeom;sdf;plug;trace;work;vt;usdShade;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/lib/tbb_debug.lib>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/lib/tbb.lib>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include/boost-1_76>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include/boost-1_76>"
)
...
set_target_properties(pxOsd PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>"
  INTERFACE_LINK_LIBRARIES "tf;vt;gf;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/lib/osdGPU.lib>;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/lib/osdCPU.lib>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/lib/osdCPU.lib>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/lib/osdGPU.lib>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>"
)
...
set_target_properties(usdImagingGL PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>"
  INTERFACE_LINK_LIBRARIES "gf;hdx;sdf;usdGeom;work;usdShade;sdr;hdsi;garch;hio;usd;tf;plug;usdHydra;pxOsd;usdImaging;hd;trace;glf;ar;vt;$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/lib/tbb_debug.lib>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/lib/tbb.lib>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "$<$<CONFIG:Debug>:{{ openUsd.rootDir.debug }}/include>;$<$<CONFIG:Release>:{{ openUsd.rootDir.release }}/include>"
)
